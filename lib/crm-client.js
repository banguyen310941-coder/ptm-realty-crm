...
export const DATA_API_URL = "https://ep-dawn-feather-az232vpl.apirest.c-3.ap-southeast-1.aws.neon.tech/neondb/rest/v1";
export const DB_URL = DATA_API_URL;
export const client = new NeonPostgrestClient({ dataApiUrl: DATA_API_URL });
...
function leadStatusCache(){if(typeof window==="undefined")return{};window.__ptmLeadStatuses=window.__ptmLeadStatuses||{};return window.__ptmLeadStatuses}
function cacheBootstrapLeadStatuses(out){if(typeof window==="undefined"||!Array.isArray(out?.leads))return;window.__ptmLeadStatuses=Object.fromEntries(out.leads.map(l=>[l.id,l.status]))}
