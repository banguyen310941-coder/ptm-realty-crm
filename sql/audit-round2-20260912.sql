...
REVOKE EXECUTE ON FUNCTION public.crm_verify_password(text,text) FROM PUBLIC;
REVOKE EXECUTE ON FUNCTION public.crm_verify_password(text,text) FROM anonymous;
REVOKE EXECUTE ON FUNCTION public.crm_pbkdf2_sha256(text,bytea,integer) FROM PUBLIC;
REVOKE EXECUTE ON FUNCTION public.crm_pbkdf2_sha256(text,bytea,integer) FROM anonymous;
REVOKE EXECUTE ON FUNCTION public.crm_b64url_decode(text) FROM PUBLIC;
REVOKE EXECUTE ON FUNCTION public.crm_b64url_decode(text) FROM anonymous;
REVOKE EXECUTE ON FUNCTION public.crm_role_permissions(text) FROM PUBLIC;
